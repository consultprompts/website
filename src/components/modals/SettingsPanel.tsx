      ...
      {user && (
        <div className={`fixed inset-0 z-[120] flex items-center justify-center ${fullScreen ? 'p-0' : 'p-0'}`}>
          ...
          <div
            ...
            className={`relative w-full bg-bg-base border border-white/5 overflow-hidden flex flex-col font-sans text-white transition-none settings:transition-[clip-path] settings:duration-300 settings:ease-in-out ${isOpen ? 'pointer-events-auto' : 'pointer-events-none'}`}
            aria-hidden={!isOpen}
          >
