                ...
                {NAV.map((n) => {
                  ...
                  return (
                    <CustomButton
                      ...
                      variant="ghost"
                      size="none"
                      className={`flex items-center gap-3 px-5 py-3 w-full text-left border-none whitespace-nowrap border-l-2 transition-colors ${
                        active ? 'bg-brand-primary/10 border-brand-primary' : 'bg-transparent border-transparent'
                      }`}
                    >
                      <span
                        className="w-2 h-2 rounded-full flex-shrink-0"
                        style={{ background: active ? 'var(--color-brand-primary)' : 'color-mix(in srgb, var(--color-ink-base) 20%, transparent)' }}
                      />
                      <span
                        style={{ color: active ? 'var(--color-ink-base)' : 'var(--color-ink-muted)' }}
